...
public class GigalandCanyonCarver extends WorldCarver<ProbabilityConfig> 
{
    private final float[] rs = new float[1024];

    public GigalandCanyonCarver(Codec<ProbabilityConfig> p_i231916_1_) 
    {
        super(p_i231916_1_, 256);
        this.replaceableBlocks = ImmutableSet.of(Blocks.STONE, Blocks.DIRT, Blocks.GRASS_BLOCK, BlockInit.GIGASTONE.get(), BlockInit.GIGALIUM_GIGALAND_ORE.get());
